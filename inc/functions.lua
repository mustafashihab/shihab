...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(shihab..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(shihab..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(shihab..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(shihab..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(shihab..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(shihab..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(shihab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(shihab..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(shihab..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(shihab..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(shihab..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(shihab..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(shihab..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(shihab..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`👨‍✈️┇مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(shihab..'username:'..v)
local count = redis:scard(shihab..'mtwr_count'..v)
...
local monsha = redis:smembers(shihab..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n\n📋¦ قائمه المدراء :*\n\n'
local list = redis:smembers(shihab..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(shihab..'admins:'..msg.chat_id_)
...
local list = redis:smembers(shihab..'whitelist:'..msg.chat_id_)
...
if redis:sismember(shihab..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(shihab..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(shihab..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(shihab..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(shihab..'gban_users')
...
local list = redis:smembers(shihab..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(shihab..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*┇*الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(shihab..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(shihab..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(shihab..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(shihab..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(shihab..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(shihab..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(shihab..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..shihab..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(shihab..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(shihab..'group:name'..GroupS) or '')
...
local admins = redis:smembers(shihab..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(shihab..'username:'..value)
if info then 
...
local creator = redis:smembers(shihab..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(shihab..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(shihab..'group:ids')
message = '📋*┇*قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(shihab..'group:name'..v)
if info then 
...
redis:del(
shihab..'group:add'..id_group,
shihab..'lock_link'..id_group, 
shihab..'lock_id'..id_group,
shihab..'lock_spam'..id_group, 
shihab..'lock_webpage'..id_group,
shihab..'lock_markdown'..id_group,
shihab..'lock_flood'..id_group,
shihab..'lock_bots'..id_group,
shihab..'mute_forward'..id_group,
shihab..'mute_contact'..id_group,
shihab..'mute_location'..id_group,
shihab..'mute_document'..id_group,
shihab..'mute_keyboard'..id_group,
shihab..'mute_game'..id_group,
shihab..'mute_inline'..id_group,
shihab..'lock_username'..id_group,
shihab..'num_msg_shihab'..id_group,
shihab..'replay'..id_group
)
redis:srem(shihab..'group:ids',id_group)
end
...
redis:hset(shihab..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(shihab..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(shihab..'group:add'..msg.chat_id_) then  return '🎗*┊*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
redis:setex(shihab..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(shihab..':addnumberusers') or 0)
...
local lock_service = redis:get(shihab..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(shihab..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(shihab..':MONSHA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
shihab..'group:add'..msg.chat_id_,true,
shihab..'lock_link'..msg.chat_id_,true, 
shihab..'lock_id'..msg.chat_id_,true,
shihab..'lock_spam'..msg.chat_id_,true,
shihab..'lock_webpage'..msg.chat_id_,true,
shihab..'lock_markdown'..msg.chat_id_,true,
shihab..'lock_flood'..msg.chat_id_,true,
...
shihab..'mute_keyboard'..msg.chat_id_,true,
shihab..'mute_game'..msg.chat_id_,true,
shihab..'mute_inline'..msg.chat_id_,true,
shihab..'lock_username'..msg.chat_id_,true,
shihab..'num_msg_shihab'..msg.chat_id_,5, 
shihab..'replay'..msg.chat_id_,true
)

redis:sadd(shihab..'group:ids',msg.chat_id_) 
redis:sadd(shihab..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(shihab..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(shihab..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(shihab..'group:add'..msg.chat_id_) then return '🛠*┊* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(shihab..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(shihab..'username:'..UserID,'username',Resolv)
redis:sadd(shihab..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(shihab..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(shihab..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(shihab..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(shihab..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(shihab..'whitelist:'..ChatID,UserID)
...
if redis:sismember(shihab..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..'owners:'..ChatID,UserID)
...
if redis:sismember(shihab..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(shihab..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(shihab..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(shihab..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(shihab..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(shihab..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(shihab..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(shihab..'banned:'..ChatID,UserID)
...
if redis:sismember(shihab..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(shihab..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(shihab..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(shihab..'username:'..UserID, 'username',Resolv)
redis:sadd(shihab..'gban_users',UserID)
...
redis:srem(shihab..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(shihab..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(shihab..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(shihab..':SUDO_BOT:',UserID)
...
redis:hset(shihab..'username:'..UserID, 'username', UserName)
redis:sadd(shihab..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎟*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(shihab..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎫*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(shihab..'username:'..UserID, 'username', Resolv)
redis:sadd(shihab..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(shihab..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(shihab..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(shihab..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » '..USERNAME..' \n🎫*┇* الايدي » (`'..UserID..'`)\n💯*┇*انه بالتأكيد ليس مطور \n✓') end
redis:srem(shihab..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(shihab..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(shihab..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(shihab..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(shihab..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾¦*` اعدادات المجموعه :` \n"
.."\n📝┇التعديل ⇜ "..(redis:get(shihab..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗┇الروابط ⇜ "..(redis:get(shihab..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣┇التاك ⇜ "..(redis:get(shihab..'lock_tag'..msg.chat_id_) or 'false')
.."\n©┇المعرفات ⇜ "..(redis:get(shihab..'lock_username'..msg.chat_id_) or 'false')
.."\n💱┇التكرار ⇜ "..(redis:get(shihab..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑┇الكلايش ⇜ "..(redis:get(shihab..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐┇الويب ⇜ "..(redis:get(shihab..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️┇الماركدوان ⇜ "..(redis:get(shihab..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻┇البوتات بالطرد ⇜ "..(redis:get(shihab..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖┇البوتات ⇜ "..(redis:get(shihab..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕┇عدد التكرار ⇜ "..(redis:get(shihab..'num_msg_shihab'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬┇`اعدادات الوسائط :`\n"
.."\n*🎑┇*المتحركه ⇜ "..(redis:get(shihab..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭┇الدردشه ⇜ "..(redis:get(shihab..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️┇الانلاين ⇜ "..(redis:get(shihab..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮┇الالعاب ⇜ "..(redis:get(shihab..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞┇الصور ⇜ "..(redis:get(shihab..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥┇الفيديو ⇜ "..(redis:get(shihab..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙┇البصمات ⇜ "..(redis:get(shihab..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉┇الصوت ⇜ "..(redis:get(shihab..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎┇الملصقات ⇜ "..(redis:get(shihab..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞┇الجهات ⇜ "..(redis:get(shihab..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱┇التوجيه ⇜ "..(redis:get(shihab..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐┇الموقع ⇜ "..(redis:get(shihab..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂┇الملفات ⇜ "..(redis:get(shihab..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅┇الاشعارات ⇜ "..(redis:get(shihab..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒┇الكيبورد ⇜ "..(redis:get(shihab..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒┇*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️┇*الترحيب ⇜ "..welcomex
.."\n*💬┇*الردود ⇜ "..replayx
...
.."\n*➕┇*عدد التكرار ⇜ "..(redis:get(shihab..'num_msg_shihab'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*💱┇*`اعدادات التقـييد :`\n"
.."\n*💢┇*التقييد بالتوجيه ⇜ "..(redis:get(shihab..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸┇*التقييد بالصور ⇜ "..(redis:get(shihab..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗┇*التقييد بالروابط ⇜ "..(redis:get(shihab..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉┇*التقييد بالمتحركه ⇜ "..(redis:get(shihab..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥┇*التقييد الفيديو ⇜ "..(redis:get(shihab..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❪ مقفول ❫')
list_settings = list_settings:gsub('false', '❪ مفتوح ❫')
