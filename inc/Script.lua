...
local function ishihab(msg,MsgText)
...
redis:setex(shihab..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(shihab..'CheckExpire::'..msg.chat_id_) then 
redis:set(shihab..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️┇تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️┇تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️┇في مجموعه  » »  '..redis:get(shihab..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(shihab..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(shihab..'CheckExpire::'..msg.chat_id_) then 
redis:set(shihab..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️┇تم تفعيل الاشتراك   👍🏿\n📆┇ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️┇تم تفعيل الاشتراك  👍🏿\n📆┇ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(shihab..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(shihab..'CheckExpire::'..msg.chat_id_) then 
redis:set(shihab..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(shihab..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(shihab..'CheckExpire::'..msg.chat_id_) then 
redis:set(shihab..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(shihab..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(shihab..'group:name'..msg.chat_id_) or '')
redis:set(shihab..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. shihab..'')
...
if not msg.Director and redis:get(shihab..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(shihab..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
local Admins = redis:scard(shihab..'admins:'..msg.chat_id_)
redis:del(shihab..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(shihab..'owners:'..msg.chat_id_)
redis:del(shihab..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(shihab..'whitelist:'..msg.chat_id_)
redis:del(shihab..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(shihab..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(shihab..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(shihab..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(shihab..'linkGroup'..msg.chat_id_) then 
return "📡*┇* اوه 🙀 لا يوجد رابط ☹️\n🔖*┇*لانشاء رابط ارسل { انشاء رابط } \n📡" 
end
local GroupName = redis:get(shihab..'group:name'..msg.chat_id_)
local GroupLink = redis:get(shihab..'linkGroup'..msg.chat_id_)
...
local Text = "🔖┇رابـط الـمـجـمـوعه 💯\n🌿┇"..Flter_Markdown(redis:get(shihab..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(shihab..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Mn3Word = redis:scard(shihab..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*┇* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(shihab..':Filter_Word:'..msg.chat_id_)
...
redis:del(shihab..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(shihab..'welcome:msg'..msg.chat_id_) then 
return "📡*┇* اوه ☢ هنالك خطأ 🚸\n♦️┇عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(shihab..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(shihab..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️┇عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(shihab..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(shihab..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌┇لا يوجد مستخدمين محظورين  *" end
message = '📋*┇* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(shihab..'banned:'..msg.chat_id_)
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."   \n♦️┇ تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local MKTOMEN = redis:scard(shihab..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*┇* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(shihab..'is_silent_users:'..msg.chat_id_)
...
redis:del(shihab..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "♦️*┇*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(shihab..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(shihab..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "♦️*┇*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(shihab..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(shihab..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(shihab..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(shihab..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(shihab..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(shihab..'lock_id'..msg.chat_id_) then
local msgs = redis:get(shihab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "🎫┇معرفـك ❪ @"..data.username_.." ❫\n" else UserNameID = "" end
local points = redis:get(shihab..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(shihab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(shihab..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(shihab..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(shihab..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(shihab..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(shihab..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(shihab..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(shihab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "♦️*┇*تم مسح {* "..msgs.." *} من رسائلك ☔️\n✓"
end

if MsgText[1]== 'جهاتي' then
return '🧟‍♂*┇*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*┇*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(shihab..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if nko == 0 then  return "⚠️*┇*عذرا ليس لديك مجوهرات لكي يتم مسحها" end
redis:del(shihab..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(shihab..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(shihab..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(shihab..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(shihab..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(shihab..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(shihab..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(shihab..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(shihab..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:set(shihab..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(shihab..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(shihab..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."  \n🌿┇نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
redis:setex(shihab..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(shihab..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜┊اهلا انآ بوت آسـمـي ]]..redis:get(shihab..':NameBot:')..[[ ✓
...
redis:setex(shihab..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭┇حسننا عزيزي 🍁\n💬┇الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(shihab..':addnumberusers',MsgText[2]) 
return '💱*┇* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*┇* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(shihab..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
return '📮*┇* عدد المجموعات المفعلة » `'..redis:scard(shihab..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين 💥" then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
return '🙍🏻‍♂*┊*عدد المشتركين في البوت : `'..redis:scard(shihab..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
if redis:sismember(shihab..'group:ids',MsgText[2]) then
local name_gp = redis:get(shihab..'group:name'..MsgText[2])
...
return redis:get(shihab..":TEXT_SUDO") or '🗃┇لا توجد كليشه المطور .\n📰┇يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
if not msg.SudoBase and not redis:get(shihab..'lock_brod') then 
return "📡*┇* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(shihab..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(shihab..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(shihab..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(shihab..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:del(shihab..'welcom:witting'..msg.sender_user_id_,
shihab..'rulse:witting'..msg.sender_user_id_,
shihab..'rulse:witting'..msg.sender_user_id_,
shihab..'name:witting'..msg.sender_user_id_,
shihab..'about:witting'..msg.sender_user_id_,
shihab..'fwd:all'..msg.sender_user_id_,
shihab..'fwd:pv'..msg.sender_user_id_,
shihab..'fwd:groups'..msg.sender_user_id_,
shihab..'namebot:witting'..msg.sender_user_id_,
shihab..'addrd_all:'..msg.sender_user_id_,
shihab..'delrd:'..msg.sender_user_id_,
shihab..'addrd:'..msg.sender_user_id_,
shihab..'delrdall:'..msg.sender_user_id_,
shihab..'text_sudo:witting'..msg.sender_user_id_,
shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_,
shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return '📬*┇* تم آلغآء آلآمـر بنجآح \n🌿'
end  


if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return '👨🏾‍🔧┊ اصدار سورس شهاب : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/shihabTELE/shihab.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*┊* يوجد تحديث جديد الان \n📡*┊* جاري تنزيل وتثبيت التحديث  ...')
redis:set(shihab..":VERSION",GetVerison)
return false
else
...
local inline = {{{text="⚜┇قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/Bots_Syria "}}}
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : شهاب](t.me/Bots_Syria )',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 🔍" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
return '🎭┊الاحصائيات 🏌‍♂ \n\n👥*┊*عدد المجموعات المفعله : '..redis:scard(shihab..'group:ids')..'\n🙍🏻‍♂*┊*عدد المشتركين في البوت : '..redis:scard(shihab..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(shihab..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "📭┇حسننا الان ارسل كلمة الرد العام 🍃\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local names 	= redis:exists(shihab..'replay:'..msg.chat_id_)
local photo 	= redis:exists(shihab..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(shihab..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(shihab..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(shihab..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(shihab..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(shihab..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(shihab..'replay:'..msg.chat_id_,shihab..'replay_photo:group:'..msg.chat_id_,shihab..'replay_voice:group:'..msg.chat_id_,
shihab..'replay_animation:group:'..msg.chat_id_,shihab..'replay_audio:group:'..msg.chat_id_,shihab..'replay_sticker:group:'..msg.chat_id_,shihab..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(shihab..'replay:all')
local photo 	= redis:exists(shihab..'replay_photo:group:')
local voice 	= redis:exists(shihab..'replay_voice:group:')
local imation 	= redis:exists(shihab..'replay_animation:group:')
local audio 	= redis:exists(shihab..'replay_audio:group:')
local sticker 	= redis:exists(shihab..'replay_sticker:group:')
local video 	= redis:exists(shihab..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(shihab..'replay:all',shihab..'replay_photo:group:',shihab..'replay_voice:group:',shihab..'replay_animation:group:',shihab..'replay_audio:group:',shihab..'replay_sticker:group:',shihab..'replay_video:group:')
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:set(shihab..'delrdall:'..msg.sender_user_id_,true) 
return "📭┊حسننا عزيزي  ✋🏿\n🗯┊الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:set(shihab..'delrd:'..msg.sender_user_id_,true)
return "📭┊حسننا عزيزي  ✋🏿\n🗯┊الان ارسل الرد لمسحها من  للمجموعه 🍃"
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local names  	= redis:hkeys(shihab..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(shihab..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(shihab..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(shihab..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(shihab..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(shihab..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(shihab..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(shihab..'replay:all')
local photo 	= redis:hkeys(shihab..'replay_photo:group:')
local voice 	= redis:hkeys(shihab..'replay_voice:group:')
local imation 	= redis:hkeys(shihab..'replay_animation:group:')
local audio 	= redis:hkeys(shihab..'replay_audio:group:')
local sticker 	= redis:hkeys(shihab..'replay_sticker:group:')
local video 	= redis:hkeys(shihab..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*┊*لا يوجد ردود مضافه حاليا \n💥' 
end
local ii = 1
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(shihab..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭┊حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(shihab..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(shihab..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."\n📡*┇* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(shihab..'lave_me'..msg.chat_id_) 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."\n📡*┇* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(shihab..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."\n📡*┇* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(shihab..'lave_me'..msg.chat_id_,true)  
...
return [[
📮┇اهلا بك في سورس شهاب🍃
⚜┇اقوه السورسات في التيليجرام 
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
🗃┇لتنصيب السورس ↓↑
💭┇افتح ترمنال جديد 
⚜┇انسخ رابط كيثاب السورس  ↡

`git clone https://github.com/mustafashihab/shihab.git ;cd shihab;chmod +x ins;./ins`
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
...
`./shihab/run`
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
📡┇[قناة السورس](t.me/Bots_Syria ) [@Bots_Syria ]
👨🏻‍✈️┇[مـطـور الـسـورس](t.me/auuuvu)
...
return '🚸*┇*عدد سحہكآتگ ⇜ ❪ '..(redis:get(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "⚠️*┇*عذرا لا يوجد سحكات لك في البوت  ✖️" end
redis:del(shihab..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
if redis:get(shihab..":UserNameChaneel") then
return "📑┊اهلا عزيزي المطور \n🔖┊الاشتراك بالتأكيد مفعل"
else
redis:setex(shihab..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local SubDel = redis:del(shihab..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local UserChaneel = redis:get(shihab..":UserNameChaneel")
if UserChaneel then
...
local function dshihab(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(shihab..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(shihab..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛┇* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(shihab..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(shihab..'users',msg.sender_user_id_)
if redis:get(shihab..'lock_service') then 
text = [[⚜┊اهلا انآ بوت آسـمـي   []]..redis:get(shihab..':NameBot:')..[[] 🎖
👨🏻‍✈️┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
local MSG_ID = (redis:get(shihab.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(shihab..'lock_twasel') then
...
redis:setex(shihab.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(shihab..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(shihab..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(shihab..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🚀 \n-')
elseif msg.photo then 
redis:hset(shihab..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه صوره للرد بنجاح ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(shihab..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه بصمه صوت للرد بنجاح ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(shihab..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه متحركه للرد بنجاح ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(shihab..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه فيديو للرد بنجاح ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(shihab..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه للصوت للرد بنجاح ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(shihab..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(shihab..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(shihab..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(shihab..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 ')
elseif msg.photo then 
redis:hset(shihab..'replay_photo:group:',klma,photo_id)
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه صوره للرد العام ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(shihab..'replay_voice:group:',klma,voice_id)
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه بصمه صوت للرد العام ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(shihab..'replay_animation:group:',klma,animation_id)
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه متحركه للرد العام ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(shihab..'replay_video:group:',klma,video_id)
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه فيديو للرد العام ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(shihab..'replay_audio:group:',klma,audio_id)
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂┊تم اضافه للصوت للرد العام ✓\n🗂┇يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(shihab..'replay_sticker:group:',klma,sticker_id)
redis:del(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(shihab..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(shihab..":ForceSub:"..msg.sender_user_id_)
...
redis:set(shihab..":UserNameChaneel",msg.text)
...
if redis:get(shihab..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(shihab..'namebot:witting'..msg.sender_user_id_)
redis:set(shihab..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭┊تم تغير اسم البوت  ✋🏿\n🗯┊الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(shihab..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(shihab..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(shihab..'replay_photo:group:',msg.text)
redis:hdel(shihab..'replay_voice:group:',msg.text)
redis:hdel(shihab..'replay_animation:group:',msg.text)
redis:hdel(shihab..'replay_audio:group:',msg.text)
redis:hdel(shihab..'replay_sticker:group:',msg.text)
redis:hdel(shihab..'replay_video:group:',msg.text)
redis:setex(shihab..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜┊جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛┊[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(shihab..'delrdall:'..msg.sender_user_id_) then
redis:del(shihab..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(shihab..'replay:all',msg.text)
local photo =redis:hget(shihab..'replay_photo:group:',msg.text)
local voice = redis:hget(shihab..'replay_voice:group:',msg.text)
local animation = redis:hget(shihab..'replay_animation:group:',msg.text)
local audio = redis:hget(shihab..'replay_audio:group:',msg.text)
local sticker = redis:hget(shihab..'replay_sticker:group:',msg.text)
local video = redis:hget(shihab..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*┊*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(shihab..'replay:all',msg.text)
redis:hdel(shihab..'replay_photo:group:',msg.text)
redis:hdel(shihab..'replay_voice:group:',msg.text)
redis:hdel(shihab..'replay_audio:group:',msg.text)
redis:hdel(shihab..'replay_animation:group:',msg.text)
...
if redis:get(shihab..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(shihab..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(shihab..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*┇* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(shihab..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(shihab..'welcom:witting'..msg.sender_user_id_) 
redis:set(shihab..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*┇* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(shihab..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(shihab..'rulse:witting'..msg.sender_user_id_) 
redis:set(shihab..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*┇* مرحبآ عزيزي\n📦┇تم حفظ القوانين بنجاح ✓\n🔖┇ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(shihab..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(shihab..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(shihab..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(shihab..'about:witting'..msg.sender_user_id_) 
...
if redis:get(shihab..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(shihab..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(shihab..'users')  
local groups = redis:smembers(shihab..'group:ids')
...
if redis:get(shihab..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(shihab..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(shihab..'users')
if #pv >= 300 then
...
if redis:get(shihab..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(shihab..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(shihab..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(shihab..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(shihab..':WELCOME_BOT'),[[⚜┊اهلا انآ بوت آسـمـي ]]..redis:get(shihab..':NameBot:')..[[ ✓
👨🏻‍✈️┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if msg.forward_info and redis:get(shihab..'fwd:'..msg.sender_user_id_) then
redis:del(shihab..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(shihab..'users')
local groups = redis:smembers(shihab..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.photo and redis:get(shihab..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(shihab..'welcom_ph:witting'..msg.sender_user_id_)
redis:set(shihab..':WELCOME_BOT',photo_id)
sendMsg(msg.chat_id_,msg.id_,'🚸┇تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
return false
end 

if msg.photo and msg.type == "channel" and msg.GroupActive then
if redis:get(shihab..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(shihab..'photo:group'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(shihab..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(shihab..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(shihab..'replay:'..msg.chat_id_,msg.text)
redis:hdel(shihab..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(shihab..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(shihab..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(shihab..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(shihab..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(shihab..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(shihab..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜┊جيد , يمكنك الان ارسال جواب الرد \n🔛┊[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(shihab..'delrd:'..msg.sender_user_id_) then
redis:del(shihab..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(shihab..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(shihab..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(shihab..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(shihab..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(shihab..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(shihab..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(shihab..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*┊*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(shihab..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(shihab..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(shihab..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(shihab..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(shihab..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(shihab..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂┇اهلن بك عزيزي {الاسم}\n🎟┇معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜┇اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(shihab..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻┇مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️┇ممنوع نشر الروابط\n⚠️┇ممنوع التكلم او نشر صور اباحيه\n⚔┇ممنوع  اعاده توجيه\n💭┇ممنوع التكلم بلطائفه\n♥️┇الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(shihab..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(shihab..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(shihab..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(shihab..'welcome:get'..msg.chat_id_)
end
redis:setex(shihab..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(shihab..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(shihab..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_shihab = (redis:get(shihab..'num_msg_shihab'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_shihab) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(shihab..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂┇العضو » "..USERNAME.."\n🚸┇قمـت بتگرآر آگثر مـن "..NUM_MSG_shihab.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(shihab..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(shihab..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(shihab..'lock_woring'..msg.chat_id_) and not redis:get(shihab..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(shihab..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(shihab..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(shihab..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*┇* لا يمكنني مسح الرساله المخالفه .\n🎟*┇* لست مشرف او ليس لدي صلاحيه  الحذف \n 💥')    
end
if redis:get(shihab..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(shihab..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(shihab..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(shihab..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(shihab..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(shihab..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(shihab..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(shihab..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(shihab..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(shihab..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(shihab..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(shihab..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(shihab..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(shihab..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(shihab..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(shihab..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(shihab..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(shihab..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(shihab..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(shihab..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(shihab..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(shihab..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(shihab..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(shihab..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(shihab..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(shihab..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(shihab..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(shihab..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(shihab..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(shihab..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(shihab..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(shihab..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(shihab..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(shihab..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(shihab..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
👨🏽‍⚖️┇بالتـوفيـق عزيزي ...
🎁┇[اضغط هنا لديك مفاجئه](https://t.me/Bots_Syria )
]] )
--=====================================
...
if redis:get(shihab..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(shihab..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️┇انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧┇المجموعه : '..FlterName(redis:get(shihab..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️┇ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️┇انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️┇سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧┇او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(shihab..'ExpireDate:'..msg.chat_id_) / 86400)
